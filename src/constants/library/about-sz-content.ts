export const AboutSZInfo = [
  {
    headerTitle: 'SwingZen analyzer app',
    content: {
      description:
        'SwingZen is a state-of-the-art AI-enhanced golf training system. Our emphasis is on bringing the most advanced tools directly to the golfer with only a smartphone and at an affordable cost.',
    },
  },
  {
    headerTitle: 'Video capture speed',
    content: {
      description: `The SwingZen system captures and analyzes videos in 120/240fps. This is up to eight times more frames than other app-based systems!
  ...
  {
    headerTitle: 'iPhone and android capabilities',
    content: {
      description: `If you have an iPhone, you have the capabilities to shoot videos at 240fps. All moderately recent versions of the iPhone have this capability, and most newer Android phones have this capability, as well. Over the last few years, Android phone manufacturers have begun providing at least 120fps slow-motion if not 240fps.
  ...
  {
    headerTitle: 'Down the line analytics',
    content: {
      description: '',
      points: [
        {
