...
export function SliderLeftIcon({ color = Color.Neutral.Sz100, width = 36, height = 36 }: SvgIconProps) {
  return <SliderLeftSvg width={width} height={height} fill={color} />;
}

export function SliderRightIcon({ color = Color.Neutral.Sz100, width = 36, height = 36 }: SvgIconProps) {
  return <SliderRightSvg width={width} height={height} fill={color} />;
}
