...
//Only the values between 0 and 60 can be used for the minutes in OTP timer. Decimal numbers like 55.5 cannot be used. Values greater than 59 or below than 0 also cannot be used.
